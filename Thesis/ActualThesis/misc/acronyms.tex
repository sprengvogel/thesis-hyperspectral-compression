...
\DeclareAcronym{dlr}{
	short = DLR,
	long = Deutsches Zentrum f{\"u}r Luft- und Raumfahrt
}
...
\DeclareAcronym{rd}{
	short = RD,
	long = Rate Distortion,
}
\DeclareAcronym{dualmse}{
	short = DualMSE,
	long = Dual Mean Squared Error,
}
\DeclareAcronym{kl}{
	short = KL,
...
\DeclareAcronym{sam}{
	short = SAM,
	long = Spectral Angle Mapper,
}
\DeclareAcronym{bpppc}{
	short = bpppc,
	long = bits per pixel per channel,
}
\DeclareAcronym{mymodel}{
	short = S2C-Net,
	long = Spatio-Spectral Compression Network,
}