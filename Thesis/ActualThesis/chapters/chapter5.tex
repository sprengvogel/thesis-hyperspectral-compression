...
\end{semilogxaxis}
\end{tikzpicture}
\caption{This graph shows the PSNR for the model FastConv and FastCombined (see \autoref{fig:shortnames}) for different subsections of the dataset. Only training and validation set sizes were reduced, all models were evaluated on the full test set.}
\label{fig:hughes}
\end{figure}
...
\end{semilogxaxis}
\end{tikzpicture}
\caption{This graph shows the spectral angle for the model FastConv and FastCombined (see \autoref{fig:shortnames}) for different subsections of the dataset. Only training and validation set sizes were reduced, all models were evaluated on the full test set.}
...
\begin{figure}
	...
	\end{semilogyaxis}
	\end{tikzpicture}
	\caption{This graph shows the Inner MSE Loss for different values of the parameter $\lambda$ for the \ac{dualmse} loss function. Inner MSE Loss is the MSE between the output of the spectral encoder and the reconstruction of that latent from the spatial autoencoder in the Combined Model.}
	\label{fig:inner_mse}
	\end{figure}
